...
function SortableContent({ ref: forwardedRef, ...props }: SortableContentProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
function SortableItem({ ref: forwardedRef, ...props }: SortableItemProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
  const {
    value,
    style,
    asHandle,
...
function SortableItemHandle({ ref: forwardedRef, ...props }: SortableItemHandleProps & { ref?: React.RefObject<HTMLButtonElement | null> }) {
